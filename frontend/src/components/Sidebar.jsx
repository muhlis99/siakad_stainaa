          ...
          {collap == 'kuliah' ?
            <details open>
              ...
              <ul className='gap-2'>
                ...
                <li>
                  <Link to="/jurnal" state={{ collaps: 'kuliah', activ: '/jurnal' }} className={`text-[#F5F5F5] rounded-md text-sm ${location.pathname == '/jurnal' || active == '/jurnal' ? 'active' : ''}`}><FaFileSignature /> <span className='text-sm'>Jurnal Kehadiran</span></Link>
                </li>
                <li>

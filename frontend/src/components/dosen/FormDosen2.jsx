                            ...
                            <div className='mt-5 grid lg:grid-cols-2'>
                                ...
                                <div>
                                    <div className='grid lg:grid-flow-col gap-1 float-right'>
                                        <div>
                                            <Link to={`/dosen/form1/${stat}/${idDsn}`} className='btn btn-sm btn-blue w-full'><FaArrowLeft /><span className="ml-1">Kembali</span></Link>
                                        </div>
                                        <div className='lg:pl-1'>
                                            <button className='btn btn-sm btn-default w-full'><FaCheck /><span className="ml-1">Selesai</span></button>
                                        </div>
                                    </div>
                                </div>
                            </div>

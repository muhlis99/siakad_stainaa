                                        ...
                                        Pembimbing.map((item, index) => (
                                            <tr key={index} className='bg-white border-b text-gray-500 border-x'>
                                                ...
                                                <td className='px-2 py-2 font-semibold' align='center'>
                                                    <div>
                                                        <Link to="/detailpembimbingakademik" state={{ kodePembimbing: item.code_pembimbing_akademik, kuota: item.kouta_bimbingan, idDsn: item.id_pembimbing_akademik, jen: item.code_jenjang_pendidikan, fak: item.code_fakultas, pro: item.code_prodi, collaps: 'kuliah', activ: '/pembimbingakademik' }} className='btn btn-info btn-xs mr-1 text-white btn-circle' ><FaSearch /></Link>

            ...
            <div className="container mx-auto">
                <div className="flex flex-col lg:flex-row w-8/12 mx-auto overflow-hidden">
                    ...
                    <div className="w-full lg:w-1/2 py-16 px-12">
                        <h2 className='text-3xl mb-3 text-[#2d8659] font-bold'>WELCOME BACK</h2>
                        <p className='text-gray-500'>Sistem Akademik Sekolah Tinggi <br />Agama Islam Nurul Abror Al-Robbaniyin</p>
                        <form>
                            <div className="mt-5">
                                <input type="text" placeholder='Username Anda' className='border border-[#2d8659] py-2 px-2 w-full rounded-xl' />
                            </div>
                            <div className="mt-5">

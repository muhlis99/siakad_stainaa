    ...
    return (
        <div className='mt-2 container'>
            ...
            <section className='mb-5'>
                <h1 className='text-2xl font-bold'>Dosen Pengajar</h1>
            </section>
            <section>

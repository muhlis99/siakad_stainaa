...
// mata_kuliah
sebaranMataKuliah.belongsTo(jadwalKuliahModel, { foreignKey: 'code_mata_kuliah' })
jadwalKuliahModel.hasMany(sebaranMataKuliah, { sourceKey: 'code_mata_kuliah', foreignKey: 'code_mata_kuliah' })

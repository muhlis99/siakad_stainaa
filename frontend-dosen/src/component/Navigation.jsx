...
const Navigation = () => {
    ...
    return (
        <div className=" bg-[#2D8659]">
            <div className="container mx-auto gap-3 flex flex-wrap py-3 px-4 md:flex-row items-center">
                <a class="flex title-font font-medium items-center text-gray-900 md:mb-0">
                    <img src={logo} width={44} />
                </a>
                <div class=" flex flex-wrap items-center text-base justify-center">
                    <a class="no-underline">First Link</a>
                    <a class="no-underline">Second Link</a>
                    <a class="no-underline">Third Link</a>
                    <a class="no-underline">Fourth Link</a>
                </div>
            </div>

                                                        ...
                                                        {Jadwal.map((item, index) => (
                                                            <tr key={item.id_jadwal_pertemuan} className='border'>
                                                                ...
                                                                <td className='py-2 text-capitalize' align='center'>
                                                                    <button className='bg-[#17A2B8] mr-1 py-1 px-1 rounded-full text-white inline-flex items-center mt-2' onClick={() => handleShow(item.id_jadwal_pertemuan, 'detail')}><FaSearch /></button>
                                                                    <button className='bg-[#FFC107] py-1 px-1 rounded-full text-white inline-flex items-center mt-2' onClick={() => handleShow(item.id_jadwal_pertemuan, 'edit')}><FaEdit /></button>
                                                                </td>
                                                            </tr>
                                                        ))}
                                                    </tbody>
